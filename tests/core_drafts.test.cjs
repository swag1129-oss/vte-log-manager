...
(async () => {
  const draft = [
    {...Core.DRAFT_LAYER_DEFAULTS, material: "HAT-CN", port: "O-3", tooling_factor: "20", ratio: "1.414", mask: "1", target_actual: "5", monitor: "3.5361", rate: "0.1",
    ...
    {...Core.DRAFT_LAYER_DEFAULTS, material: "Ir(ppy)3", port: "O-4", tooling_factor: "100", ratio: "0.19375", mask: "2", target_actual: "10", monitor: "51.6129", rate: "0.1",
  ...
  assert.deepEqual(layers.map(l => [l.material, l.target_actual, l.rate, l.mask]), [["HAT-CN", "10", "0.1", "1"], ["CBP", "28.2", "0.282", "2"], ["Ir(ppy)3", "1.8", "0.018", "2"]]);
